...
public class constructPrior {
    public static void main(String[] args) throws Exception {
        ...
        HashMap<String, Integer> map = getScores(gp);//maps from Gene,Gene to score
        System.out.println("Done");
        gp = null;

        DataSet data = MixedUtils.loadDataSet2("Highest_Variance_Data_No_DP_Disc.txt");


        System.out.print("Constructing prior from map and data...");
        DoubleMatrix2D prior = makePrior(map, data);
        System.out.println("Done");
